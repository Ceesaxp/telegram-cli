...
// MaxMessageId. It is the local half of [ChatReadInboxMsg]: the server's
// receipt for a read made by this session does not reliably come back, and
// without this the chat being read kept its unread badge.
