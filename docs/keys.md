...
| `g@` | Jump to the next unread mention in this chat, **oldest first**, and clear it; press again for the one after. It jumps rather than arms: the destination is a message in the chat you are reading. `Ctrl+O` comes back. The hint bar says how many remain |
